...
const Capabilities = () => {
  ...
  return (
    <div className="w-full h-fit text-desc-custom my-20">
      <div className="font-bold text-right mb-10 text-title-custom">
      ...
      <div>
        <h2 className="text-right my-10 md:text-subtitle-custom text-subtitle-custom-mv">
          Capabilities
        </h2>
        <div className="flex md:flex-row flex-col-reverse w-full justify-between">
          <div className="md:w-[45%] w-full h-fit md:m-auto my-10 bg-gradient-to-r from-[#AA00FF] to-[#0044FF] py-8 px-12 rounded-[30px]">
            <p>{arr[data].desc}</p>
          </div>
