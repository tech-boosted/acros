...
const Section5 = () => {
  return (
    <div className="w-screen">
      <div className="font-satoshi-bold my-10 w-[92%] rounded-[30px] px-10 h-fit bg-gradient-to-tr from-green-300 via-cyan-300 to-cyan-500 mx-auto py-10  text-center text-desc-custom ">
