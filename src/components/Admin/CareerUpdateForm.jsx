...
import { putMiddleware } from "../../middleware";

const CareerUpdateForm = ({ formData, setFormData, id }) => {
  ...
  const handleSubmit = (e) => {
    ...
    putMiddleware(`/career/${id}`, formData, callback, true);
