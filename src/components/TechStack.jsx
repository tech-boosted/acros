  ...
  return (
    <div className="w-full my-10 text-center text-desc-custom">
      ...
      <div className="my-10 w-full bg-gradient-to-r from-[#aa00ff] from-73% to-[#0044ff] rounded-[30px] grid md:grid-cols-7 grid-cols-1  md:justify-center md:gap-8 gap-8 px-8 py-2 items-center">
        ...
        />
        <img src={TechStackLogo3} alt="sidle" className=" block m-auto md:h-fit h-[30px]" />
        <img src={TechStackLogo4} alt="tetramind" className=" block m-auto md:h-fit h-[35px]" />
        <img src={TechStackLogo5} alt="wake" className=" block m-auto md:h-fit h-[40px]" />
        <img src={TechStackLogo6} alt="xp strategy" className=" block m-auto md:fit h-[40px]" />
        <img src={TechStackLogo7} alt="xp strategy" className=" block m-auto md:h-fit w-[60%] " />
      </div>
      ...
      <div className=" flex items-center justify-center  ">
        <div className="my-16 w-full text-right">
          ...
          <div className="grid md:grid-cols-4 grid-cols-1 gap-4 text-center">
            <div>
              <h1 className="md:text-title-custom text-title-custom-mv font-satoshi-bold">150+</h1>
              <p className="font-satoshi-medium">
                Extensive Experience with Top E-commerce Brands
              </p>
            </div>
            <div>
              <h1 className="md:text-title-custom text-title-custom-mv font-satoshi-bold">15+</h1>
              <p className="font-satoshi-medium">
                Expanding Horizons with Clients from 15+ Countries
              </p>
            </div>
            <div>
              <h1 className="md:text-title-custom text-title-custom-mv font-satoshi-bold">70+</h1>
              <p className="font-satoshi-medium">Amplify your Growth with our Team of Experts</p>
            </div>
            <div>
              <h1 className="md:text-title-custom text-title-custom-mv font-satoshi-bold">12+</h1>
              <p className="font-satoshi-medium">Ecommerce Solutions Perfected over 12+ Years</p>
            </div>
          </div>
        </div>
      </div>
