...
const Section9 = () => {
  return (
    ...
    <div className="md:w-[35%] text-white rounded-[30px] h-fit bg-gradient-to-br from-[#1de5e2] from-40% via-[#6196e8] via-60% to-[#955aec] px-10   py-10">
      <div className="w-fit grid grid-cols-2 gap-4 gap-y-4 mx-auto">
        <div className="md:w-[140px] md:h-[140px] w-[100px] h-[100px] bg-black bg-opacity-40 rounded-[200px] flex items-center justify-center px-[10px]">
          <img
            src={TechStackLogo1}
            alt="clever click 360"
