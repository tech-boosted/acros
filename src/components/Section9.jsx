...
const Section9 = () => {
  return (
    <div className="flex flex-col md:w-[50%] w-screen pl-[1%] pr-[4%] gap-10 my-10">
      ...
      <div className="text-white rounded-[30px] h-fit bg-gradient-to-br from-[#1de5e2] from-40% via-[#6196e8] via-60% to-[#955aec] px-10   py-10">
