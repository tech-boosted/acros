        ...
        <div className="w-full md:h-[40vh] h-fit bg-gradient-to-br from-[#cef76d] from-1%  via-[#66b636] via-40%  to-[#00e89e] to-80% rounded-[30px] px-10 py-4">
          ...
          <div className="text-left flex-col  mt-4">
            <p className="">
              ...
              Advertising Experts who can create conversion focused ad campaigns
              and strategies that resonate with the e-commerce target audience.
              They work with highly efficient customer behaviour patterns,
              buyers mind mapping and decision influencing tools to deliver
              gold-standard ROI.
            </p>
        ...
        <div className="w-full md:h-[40vh] h-fit bg-gradient-to-tr from-[#ff9022] from-25% via-50%   via-[#bb65da]  to-[#7034fc] to-65%     rounded-[30px] px-10 py-4">
          ...
          <div className="text-left flex-col  mt-4">
            <p className="">
              ...
              to an Ad agency's needs. Our Ad Operations team handles all
              aspects of your ads, Freeing up your resources and time to focus
          ...
          <div className="my-16 w-full text-right">
            ...
            <div className=" mb-8">
              <p>
                ...
                with diverse customer segments. By tailoring their messaging and
                promotions to specific regions and cultures, we build brand
                loyalty and generate sales effectively.
              </p>
            </div>
